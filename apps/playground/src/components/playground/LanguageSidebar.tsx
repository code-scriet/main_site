      ...
      {onOpenPractice && (
        <button
          ...
          className={cn(
            ...
            'hover:bg-accent/80',
            isDark
              ? 'bg-gradient-to-br from-amber-500/10 to-orange-500/10 ring-1 ring-amber-500/30 text-amber-400'
              : 'bg-gradient-to-br from-amber-500/15 to-orange-500/10 ring-1 ring-amber-500/40 text-amber-700',
          )}
        >
          <BookOpenCheck className="h-4 w-4" />
          <span className="text-[9px] font-medium leading-none">Solve</span>
        </button>
      )}
      {languages.map((lang) => {

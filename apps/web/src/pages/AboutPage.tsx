...
export default function AboutPage() {
  const timeline = [
    { year: '2025', title: 'Club Founded', description: 'code.scriet was founded by our seniors, Prince Bhaiya and Girdhari Bhaiya, with a shared vision to build a strong coding culture.' },

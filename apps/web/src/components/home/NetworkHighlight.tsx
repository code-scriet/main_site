...
export function NetworkHighlight() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-gray-100/50 bg-gradient-to-b from-gray-50/30 via-gray-100/40 to-gray-50/60 py-16 sm:py-24 lg:py-28 dark:border-[rgba(244,241,234,0.08)] dark:from-[#111110] dark:via-[#0A0908] dark:to-[#111110]">
      {/* Background Effects */}

...
export function CTASection() {
  ...
  // Floating droplets drifting up behind the CTA (decorative). Denser + larger
  // than the original so the rising motion reads prominently before the footer;
  // disabled under reduced motion (and on small screens via CSS).

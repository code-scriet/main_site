...
// NOTE: RichContent (the raw-HTML/DOMPurify path) moved to ./markdown-rich so its
// heavy deps (rehype-raw → parse5, dompurify) are code-split away from the plain
// Markdown/InlineMarkdown components used by the SEO detail pages. Import it from
// '@/components/ui/markdown-rich'.

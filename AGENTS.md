# AGENTS.md — code.scriet Club Platform
...
- **CompetitionRound / CompetitionSubmission / CompetitionAutoSave** — multi-round competition system (round scope supports all teams or selected teams)
...
- **Settings** — singleton (id='default'), feature toggles, social URLs, email templates, privileged security env references (`ATTENDANCE_JWT_SECRET`, `INDEXNOW_KEY`)
